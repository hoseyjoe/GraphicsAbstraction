...
var com_realitycharting_flash_TextField = function() {
	...
	this.defaultTextFormat = new com_realitycharting_flash_TextFormat("arial",12,16773120);
	this.set_x(0);
	this.set_y(0);
	this.rotation = 0;
};
...
com_realitycharting_flash_TextField.prototype = $extend(com_realitycharting_flash_DisplayObject.prototype,{
	...
	,renderSvg: function(canvas,xx,yy) {
		...
		console.log("src/com/realitycharting/flash/TextField.hx:58:",this.get_text());
		if(this.rotation != 0) {
			this.svgString += "<g transform=\"translate(" + (this.get_x() + xx) + "," + (this.get_y() + yy + this.get_height()) + ")\"><text text-anchor=\"end\" fill=\"#" + StringTools.hex(this.defaultTextFormat.fontColor) + "\" transform=\"rotate(" + this.rotation + ")\" font-family=\"" + this.defaultTextFormat.fontName + "\" font-size=\"" + this.defaultTextFormat.fontSize + "\">" + this.get_text() + "</text></g>";
		} else {
			this.svgString += "<g transform=\"translate(" + (this.get_x() + xx) + "," + (this.get_y() + yy + this.get_height()) + ")\"><text text-anchor=\"end\" fill=\"#" + StringTools.hex(this.defaultTextFormat.fontColor) + "\" transform=\"rotate(" + this.rotation + ")\" font-family=\"" + this.defaultTextFormat.fontName + "\" font-size=\"" + this.defaultTextFormat.fontSize + "\">" + this.get_text() + "</text></g>";
		}
	}
	,render: function(canvas,xx,yy) {
		...
		if(canvas == null) {
			console.log("src/com/realitycharting/flash/TextField.hx:97:","NULL *************");
		}
